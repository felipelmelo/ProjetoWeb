			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link" href="../produto/ExbirProduto.php"><i class="icon-edit"></i><span class="hidden-tablet"> Produto</span></a></li>
					...
					<div class="box-content">
						<form class="form-horizontal" method = "post" action = 'trataInserir.php' onsubmit="return validacoes(this);">
						  <fieldset>
							...
							<div class="control-group">
							  <label class="control-label" name = "typeahead"  id = "senha"  for="typeahead">Senha: </label>
							  <div class="controls">
